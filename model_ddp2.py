...
# optimizer should use gpt.module
# zero grad should occur only once per batch
# autocast should use rank device
...
def train(rank, world_size):
    ...
    optimizer = torch.optim.AdamW(gpt_model.parameters(), lr=0.0005, betas=(0.9, 0.95))
